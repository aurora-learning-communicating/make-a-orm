...
public class TestORM {
    ...
    static class NumberCollectionTable extends IntIdTable {
        public IntegerColumn column1 = integer("integer");
        public DoubleColumn column2 = float64("double");
        public SmallIntColumn column3 = smallint("short");
        public TinyIntColumn column4 = tinyint("byte");
